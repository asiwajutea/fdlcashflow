          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateRate("field_work_rate", e.target.value)}
                placeholder="90"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="virtual_audit_rate">Virtual Audit (per audit)</Label>
              <Input
                id="virtual_audit_rate"
                type="number"
                value={rates.virtual_audit_rate}
                onChange={(e) => updateRate("virtual_audit_rate", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="data_entry_rate">Data Entry (per entry)</Label>
              <Input
                id="data_entry_rate"
                type="number"
                value={rates.data_entry_rate}
                onChange={(e) => updateRate("data_entry_rate", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="bac_audit_rate">BAC Audit (per audit)</Label>
              <Input
                id="bac_audit_rate"
                type="number"
                value={rates.bac_audit_rate}
                onChange={(e) => updateRate("bac_audit_rate", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="metadata_audit_rate">Metadata Audit (per audit)</Label>
              <Input
                id="metadata_audit_rate"
                type="number"
                value={rates.metadata_audit_rate}
                onChange={(e) => updateRate("metadata_audit_rate", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="booklet_rate">Booklet Income (per booklet)</Label>
              <Input
                id="booklet_rate"
                type="number"
                value={rates.booklet_rate}
                onChange={(e) => updateRate("booklet_rate", e.target.value)}
                placeholder="0"
              />
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                id="production_manager_salary"
                type="number"
                value={rates.production_manager_salary}
                onChange={(e) => updateRate("production_manager_salary", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="fixed_monthly_salaries"
                type="number"
                value={rates.fixed_monthly_salaries}
                onChange={(e) => updateRate("fixed_monthly_salaries", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="operations_utilities"
                type="number"
                value={rates.operations_utilities}
                onChange={(e) => updateRate("operations_utilities", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="employee_gratuity"
                type="number"
                value={rates.employee_gratuity}
                onChange={(e) => updateRate("employee_gratuity", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="logistics"
                type="number"
                value={rates.logistics}
                onChange={(e) => updateRate("logistics", e.target.value)}
                placeholder="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                id="incentives"
                type="number"
                value={rates.incentives}
                onChange={(e) => updateRate("incentives", e.target.value)}
                placeholder="0"
              />
            </div>
          </CardContent>
