    ...
    <Card className="financial-card p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Rate Configuration</h2>
      ...
      <div className="space-y-8">
        {/* Income Rates Per Name */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Income - Pay Per Name</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                id="field_work_rate"
                type="number"
                value={rates.field_work_rate}
                onChange={(e) => updateRate('field_work_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="data_entry_rate"
                type="number"
                value={rates.data_entry_rate}
                onChange={(e) => updateRate('data_entry_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="bac_audit_rate"
                type="number"
                value={rates.bac_audit_rate}
                onChange={(e) => updateRate('bac_audit_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="metadata_audit_rate"
                type="number"
                value={rates.metadata_audit_rate}
                onChange={(e) => updateRate('metadata_audit_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="virtual_audit_rate"
                type="number"
                value={rates.virtual_audit_rate}
                onChange={(e) => updateRate('virtual_audit_rate', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Fixed Income */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Income - Fixed Monthly</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="booklet_monthly_income">Booklet Production</Label>
              <Input
                id="booklet_monthly_income"
                type="number"
                value={rates.booklet_monthly_income}
                onChange={(e) => updateRate('booklet_monthly_income', Number(e.target.value))}
                className="mt-1"
              />
        ...
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Field Staff Salaries (Per Name)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                id="field_agent_rate"
                type="number"
                value={rates.field_agent_rate}
                onChange={(e) => updateRate('field_agent_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="field_manager_rate"
                type="number"
                value={rates.field_manager_rate}
                onChange={(e) => updateRate('field_manager_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="booking_agent_rate"
                type="number"
                value={rates.booking_agent_rate}
                onChange={(e) => updateRate('booking_agent_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="field_relation_rate"
                type="number"
                value={rates.field_relation_rate}
                onChange={(e) => updateRate('field_relation_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="field_misc_rate"
                type="number"
                value={rates.field_misc_rate}
                onChange={(e) => updateRate('field_misc_rate', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Data Entry */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Data Entry (Per Name)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <Label htmlFor="data_entry_clerks_rate">Data Entry Clerks</Label>
              <Input
                id="data_entry_clerks_rate"
                type="number"
                value={rates.data_entry_clerks_rate}
                onChange={(e) => updateRate('data_entry_clerks_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="qa_manager_rate"
                type="number"
                value={rates.qa_manager_rate}
                onChange={(e) => updateRate('qa_manager_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="data_entry_misc_rate"
                type="number"
                value={rates.data_entry_misc_rate}
                onChange={(e) => updateRate('data_entry_misc_rate', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Production Manager */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Production Manager (Per Name)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <Label htmlFor="pm_field_work_rate">PM Field Work</Label>
              <Input
                id="pm_field_work_rate"
                type="number"
                value={rates.pm_field_work_rate}
                onChange={(e) => updateRate('pm_field_work_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="pm_data_entry_rate"
                type="number"
                value={rates.pm_data_entry_rate}
                onChange={(e) => updateRate('pm_data_entry_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="pm_bac_audit_rate"
                type="number"
                value={rates.pm_bac_audit_rate}
                onChange={(e) => updateRate('pm_bac_audit_rate', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Fixed Monthly Salaries */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Fixed Monthly Salaries</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <Label htmlFor="field_relation_supervisor_salary">Field Relation Supervisor</Label>
              <Input
                id="field_relation_supervisor_salary"
                type="number"
                value={rates.field_relation_supervisor_salary}
                onChange={(e) => updateRate('field_relation_supervisor_salary', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="administrative_assistant_salary"
                type="number"
                value={rates.administrative_assistant_salary}
                onChange={(e) => updateRate('administrative_assistant_salary', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="field_relation_officers_salary"
                type="number"
                value={rates.field_relation_officers_salary}
                onChange={(e) => updateRate('field_relation_officers_salary', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Recurring Monthly Costs */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Recurring Monthly Costs</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <Label htmlFor="power_plant_monthly">Power Plant</Label>
              <Input
                id="power_plant_monthly"
                type="number"
                value={rates.power_plant_monthly}
                onChange={(e) => updateRate('power_plant_monthly', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="office_data_subscription_monthly"
                type="number"
                value={rates.office_data_subscription_monthly}
                onChange={(e) => updateRate('office_data_subscription_monthly', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                id="staff_data_support_monthly"
                type="number"
                value={rates.staff_data_support_monthly}
                onChange={(e) => updateRate('staff_data_support_monthly', Number(e.target.value))}
                className="mt-1"
              />
        ...
        {/* Percentage-Based */}
        <section>
          <h3 className="text-lg font-semibold text-foreground mb-4">Expenses - Percentage-Based</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <Label htmlFor="employee_gratuity_rate">Employee Gratuity Fund</Label>
              <Input
                id="employee_gratuity_rate"
                type="number"
                step="0.001"
                value={rates.employee_gratuity_rate}
                onChange={(e) => updateRate('employee_gratuity_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                step="0.001"
                value={rates.logistics_rate}
                onChange={(e) => updateRate('logistics_rate', Number(e.target.value))}
                className="mt-1"
              />
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                step="0.001"
                value={rates.incentives_rate}
                onChange={(e) => updateRate('incentives_rate', Number(e.target.value))}
                className="mt-1"
              />
