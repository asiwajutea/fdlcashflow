  ...
  return <div className="space-y-8">
      ...
      <Card className="financial-card p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-600">Chart Filters</h3>
        </div>
      ...
      <Card className="financial-card p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-600">Weekly Financial Trend</h3>
        ...
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={filteredData}>
            ...
            <XAxis dataKey="week" stroke="hsl(var(--muted-foreground))" fontSize={12} angle={-45} textAnchor="end" height={80} />
            ...
            <Legend />
            {(comparisonType === 'both' || comparisonType === 'income') && <Line type="monotone" dataKey="income" stroke="hsl(var(--success))" strokeWidth={3} name="Income" dot={{
            r: 4
          }} activeDot={{
            r: 6
          }} />}
            {(comparisonType === 'both' || comparisonType === 'expenses') && <Line type="monotone" dataKey="expenses" stroke="hsl(var(--danger))" strokeWidth={3} name="Expenses" dot={{
            r: 4
          }} activeDot={{
            r: 6
          }} />}
            {comparisonType === 'both' && <Line type="monotone" dataKey="netCashflow" stroke="hsl(var(--primary))" strokeWidth={3} name="Net Cashflow" dot={{
            r: 4
          }} activeDot={{
            r: 6
          }} />}
      ...
      <Card className="financial-card p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800">Monthly Performance Comparison</h3>
        ...
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={monthlyData}>
            <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--muted-dark))" />
            <XAxis dataKey="month" stroke="hsl(var(--muted-foreground))" fontSize={12} angle={-45} textAnchor="end" height={80} />
            <YAxis stroke="hsl(var(--muted-foreground))" fontSize={12} tickFormatter={formatCurrency} />
            ...
            <Legend />
            {(comparisonType === 'both' || comparisonType === 'income') && <Bar dataKey="income" fill="hsl(var(--success))" radius={[4, 4, 0, 0]} name="Income" />}
            {(comparisonType === 'both' || comparisonType === 'expenses') && <Bar dataKey="expenses" fill="hsl(var(--danger))" radius={[4, 4, 0, 0]} name="Expenses" />}
          </BarChart>
        </ResponsiveContainer>
      </Card>
      ...
      <Card className="financial-card p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800">Work Volume Analysis</h3>
