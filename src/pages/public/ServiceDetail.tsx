    ...
    <PublicLayout>
      <section className="bg-[hsl(214,95%,15%)] py-16">
        <div className="max-w-7xl mx-auto px-4">
          <Link to="/services" className="inline-flex items-center text-[hsl(28,100%,55%)] hover:underline mb-4 text-sm">
      ...
      <section className="bg-white py-16">
        <div className="max-w-3xl mx-auto px-4">
          <p className="text-[hsl(210,15%,40%)] leading-relaxed text-lg mb-8">{service.description || service.short_description}</p>
