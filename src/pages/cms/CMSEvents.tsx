...
const empty = { title: '', slug: '', short_description: '', description: '', display_order: 0, is_published: true, event_date: '', registration_url: '' };
  ...
  return (
    <DashboardLayout title="Manage Events">
      ...
      <div className="bg-card rounded-lg border">
        <Table>
          <TableHeader><TableRow><TableHead>Order</TableHead><TableHead>Title</TableHead><TableHead>Date</TableHead><TableHead>Published</TableHead><TableHead className="w-20"></TableHead></TableRow></TableHeader>
          <TableBody>
            {items.map((s) => (
              <TableRow key={s.id}>
