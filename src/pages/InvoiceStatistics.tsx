          ...
          {topEmployees.length > 0 && <Card className="transition-all duration-300 hover:shadow-lg border border-border/50 shadow-sm">
              ...
              <CardContent>
                <div className="space-y-3">
                  {topEmployees.map((employee, index) => <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-muted/50 hover:bg-muted transition-colors text-muted-foreground hover:text-white">
